...
export const glossary: GlossaryEntry[] = [
  ...
  {id: 'ucp', term: 'Universal Commerce Protocol', acronym: 'UCP',
   short: 'The commerce layer: a standard Checkout Object that AP2 signs as a Checkout Mandate.',
   spec: 'A protocol providing a Checkout Object standard when used with the Checkout Mandate (ucp.dev).'},
  {id: 'mcp', term: 'Model Context Protocol', acronym: 'MCP',
   short: 'Standard for connecting agents to external tools, APIs, and data.',
   spec: 'A protocol standardizing how AI models and agents connect to and interact with external resources like tools, APIs, and data sources.'},
