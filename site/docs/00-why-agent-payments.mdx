...
- Name two of the four trust questions that agents break.
- Why isn't an LLM's say-so enough to authorize a payment?
- What does AP2 anchor transactions to instead of inferred action?
