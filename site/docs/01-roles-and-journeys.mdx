...
- The <Term id="network-issuer">Network / Issuer</Term> runs the underlying payment rails, issues the credentials, and performs the final authorization, just as it does for card payments today.
