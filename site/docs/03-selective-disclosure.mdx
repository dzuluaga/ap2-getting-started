...
**Further reading:** [RFC 9901 — SD-JWT](https://datatracker.ietf.org/doc/rfc9901/), the [AP2 SDK `sdjwt` README](https://github.com/google-agentic-commerce/AP2/blob/main/code/sdk/python/ap2/sdk/README.md), and the [AP2 spec — security & privacy considerations](https://github.com/google-agentic-commerce/AP2/blob/main/docs/ap2/security_and_privacy_considerations.md).
